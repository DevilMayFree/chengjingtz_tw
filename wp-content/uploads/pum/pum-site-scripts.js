 ...
 * Last modified time: 2 月 14 2025, 05:57:38
 */
...
!function (i) {
    ...
    void 0 === i.fn.on && (i.fn.on = function (e, o, t) {
        ...
        var e = i(this).offset().top, o = e + i(this).outerHeight(), t = i(window).scrollTop(),
            n = t + i(window).height();
        return t < o && e < n
    }), void 0 === Date.now && (Date.now = function () {
        return (new Date).getTime()
    })
}(jQuery), function (a, r, s) {
    "use strict";
    ...
    window.pum_vars = window.pum_vars || {
        ...
        get: new function () {
            ...
            if (n !== s && n.length) for (t = 0; n.length > t; t += 1) a.pm_remove_cookie(n[t].settings.name);
            "function" == typeof o && o()
        }, getClickTriggerSelector: function (e, o) {
            var t = PUM.getPopup(e), e = PUM.getSettings(e),
            ...
            if (e !== s) if (o !== s) {
                ...
                if (n.length) for (var i = 0; n.length > i; i++) -1 !== pum.hooks.applyFilters("pum.disableClickTriggers.clickTriggerTypes", ["click_open"]).indexOf(n[i].type) && (t = PUM.getClickTriggerSelector(e, n[i].settings), a(t).removeClass("pum-trigger"), a(r).off("click.pumTrigger click.popmakeOpen", t))
            }
        }, actions: {
            stopIframeVideosPlaying: function () {
                ...
                e.hasClass("pum-has-videos") || (o.find("iframe").filter('[src*="youtube"],[src*="vimeo"]').each(function () {
                    var e = a(this), o = e.attr("src"), t = o.replace("autoplay=1", "1=1");
        ...
        init: function () {
            ...
            var o = PUM.getPopup(this), t = o.popmake("getContainer"), n = o.popmake("getClose"),
                i = o.popmake("getSettings"), r = a("html");
            ...
            }), o.trigger("pumAfterReposition"), t.addClass("custom-position").position(r).trigger("popmakeAfterReposition"), "center" === i && t[0].offsetTop < 0 && t.css({top: a("body").hasClass("admin-bar") ? 42 : 10}), e.overlay && o.css({opacity: e.overlay}).hide(0), e.container && t.css({opacity: e.container}).hide(0), this
    ...
    e.fn.popmake.version = 1.8, e.fn.popmake.last_open_popup = null, window.ajaxurl = window.pum_vars.ajaxurl, window.PUM.init = function () {
        ...
        var e = PUM.getPopup(this), o = PUM.getSetting(e, "id"), e = e.find("form");
    ...
    PUM_Accessibility = {
        forceFocus: function (e) {
            ...
            var e = PUM.getPopup(this), o = i(":focus");
    ...
    }).on("pumAfterOpen", e, PUM_Accessibility.initiateFocusLock).on("pumAfterOpen", e, function () {
        var e = PUM.getPopup(this);
    ...
    PUM_Analytics = {
        beacon: function (e, o) {
            var t = new Image, n = r ? pum_vars.analytics_api : pum_vars.ajaxurl, o = {
        ...
        var e = PUM.getPopup(this), e = {pid: parseInt(e.popmake("getSettings").id, 10) || null};
    ...
    n.fn.popmake.methods.animate_overlay = function (e, o, t) {
        ...
        none: function (e) {
            ...
            return s(o), o.css({opacity: 0, display: "block"}), t.css({
                opacity: 0,
                display: "block"
            ...
            var e = PUM.getPopup(this), t = e.popmake("getContainer"), n = e.popmake("getSettings"),
                i = e.popmake("animation_origin", n.animation_origin);
            return s(e), e.css({display: "block", opacity: 0}), t.css({
                display: "block",
                opacity: 0
    ...
    p.extend(p.fn.popmake.methods, {
        checkConditions: function () {
            var e, o, t, n, i, r = PUM.getPopup(this), s = r.popmake("getSettings"), a = !0;
            if (s.disable_on_mobile && u().phone()) return !1;
            if (s.disable_on_tablet && u().tablet()) return !1;
            if (s.conditions.length) for (o = 0; s.conditions.length > o; o++) {
                for (n = s.conditions[o], e = !1, t = 0; n.length > t; t++) if ("boolean" != typeof n[t]) {
                    if ((!(i = p.extend({}, {not_operand: !1}, n[t])).not_operand && r.popmake("checkCondition", i) || i.not_operand && !r.popmake("checkCondition", i)) && (e = !0), p(this).trigger("pumCheckingCondition", [e, i]), e) break
                } else if (n[t]) {
                    e = !0;
                    break
                }
    ...
    function f(e, o, t) {
        ...
        if ("undefined" != typeof document) {
            if (1 < arguments.length) {
                switch (typeof (t = l.extend({path: pum_vars.home_url}, f.defaults, t)).expires) {
                    case"number":
                        i.setMilliseconds(i.getMilliseconds() + 864e5 * t.expires), t.expires = i;
                        break;
                    case"string":
                        i.setTime(1e3 * l.fn.popmake.utilities.strtotime("+" + t.expires)), t.expires = i
                }
                try {
            ...
            for (var r = document.cookie ? document.cookie.split("; ") : [], s = /(%[0-9A-Z]{2})+/g, a = 0; a < r.length; a++) {
                var p = r[a].split("=");
                '"' === (c = p.slice(1).join("=")).charAt(0) && (c = c.slice(1, -1));
                try {
                    var u = p[0].replace(s, decodeURIComponent),
                        c = d.read ? d.read(c, u) : d(c, u) || c.replace(s, decodeURIComponent);
                    if (this.json) try {
                        c = JSON.parse(c)
                    } catch (e) {
                    }
    ...
    var d;
    l.extend(l.fn.popmake, {
        cookie: (void 0 === d && (d = function () {
        }), (f.set = f).get = function (e) {
            return f.call(f, e)
        }, f.getJSON = function () {
            return f.apply({json: !0}, [].slice.call(arguments))
        }, f.defaults = {domain: pum_vars.cookie_domain || ""}, f.remove = function (e, o) {
            f(e, "", l.extend({}, o, {expires: -1, path: ""})), f(e, "", l.extend({}, o, {expires: -1}))
        }, f.process = function (e, o, t, n) {
            return f.apply(f, 3 < arguments.length && "object" != typeof t && void 0 !== o ? [e, o, {
                expires: t,
                path: n
            }] : [].slice.call(arguments, [0, 2]))
        }, f.withConverter = l.fn.popmake.cookie, f)
    }), pm_cookie = l.pm_cookie = l.fn.popmake.cookie.process, pm_cookie_json = l.pm_cookie_json = l.fn.popmake.cookie.getJSON, pm_remove_cookie = l.pm_remove_cookie = l.fn.popmake.cookie.remove
    ...
    i.extend(i.fn.popmake.methods, {
        ...
        }, setCookie: r, checkCookies: function (e) {
            var o, t = !1;
        ...
        var e, o, t = PUM.getPopup(this), n = t.popmake("getSettings").cookies || [];
        if (n.length) for (o = 0; o < n.length; o += 1) e = n[o], t.popmake("addCookie", e.event, e.settings)
    }), i(function () {
        var e = i(".pum-cookie");
        e.each(function () {
...
!function (s, e) {
    var a, o, p;
    e = window.pum_vars || {debug_mode: !1}, (pum_debug_mode = !(pum_debug_mode = void 0 !== e.debug_mode && e.debug_mode) && -1 !== window.location.href.indexOf("pum_debug") ? !0 : pum_debug_mode) && (o = a = !1, p = window.pum_debug_vars || {
        ...
        odump: function (e) {
            ...
            try {
                var o, t = 0, n = " " + new Array(63).join("-") + " ", i = e;
        ...
        var e = PUM.getPopup(s(this)), o = e.popmake("getSettings"), t = o.triggers || [], n = o.cookies || [],
            i = o.conditions || [], r = 0;
        ...
        var e = PUM.getPopup(s(this)), o = s.fn.popmake.last_open_trigger;
    ...
    window.PUM = window.PUM || {}, window.PUM.forms = window.PUM.forms || {}, r.extend(window.PUM.forms, {
        form: {
            validation: {errors: []}, responseHandler: function (e, o) {
                ...
                var o = r(this), t = o.pumSerializeObject();
    ...
    e.pum = e.pum || {}, e.pum.hooks = e.pum.hooks || new function () {
        ...
        function n(e, o, t, n) {
            var i, r, s;
            if (a[e][o]) if (t) if (i = a[e][o], n) for (s = i.length; s--;) (r = i[s]).callback === t && r.context === n && i.splice(s, 1); else for (s = i.length; s--;) i[s].callback === t && i.splice(s, 1); else a[e][o] = []
        }

        function r(e, o, t, n, i) {
            n = {callback: t, priority: n, context: i}, i = (i = a[e][o]) ? (i.push(n), function (e) {
        ...
        function s(e, o, t) {
            ...
            if (i = r.length, "filters" === e) for (n = 0; n < i; n++) t[0] = r[n].callback.apply(r[n].context, t); else for (n = 0; n < i; n++) r[n].callback.apply(r[n].context, t);
    ...
    pum_vars && void 0 !== pum_vars.core_sub_forms_enabled && !pum_vars.core_sub_forms_enabled || (window.PUM = window.PUM || {}, window.PUM.newsletter = window.PUM.newsletter || {}, s.extend(window.PUM.newsletter, {
        ...
        var t = s(e.target), n = t.data("settings") || {}, i = t.pumSerializeObject(), r = PUM.getPopup(t),
            e = PUM.getSetting(r, "id"), r = s("form.pum-sub-form", r).index(t) + 1;
    ...
    r.extend(r.fn.popmake.methods, {
        ...
        auto_open: function (e) {
            ...
            var i = PUM.getPopup(this), e = i.popmake("getSettings"),
                e = [".popmake-" + e.id, ".popmake-" + decodeURIComponent(e.slug), 'a[href$="#popmake-' + e.id + '"]'];
            n.extra_selectors && "" !== n.extra_selectors && e.push(n.extra_selectors), e = (e = pum.hooks.applyFilters("pum.trigger.click_open.selectors", e, n, i)).join(", "), r(e).addClass("pum-trigger").css({cursor: "pointer"}), r(o).on("click.pumTrigger", e, function (e) {
                var o = r(this), t = n.do_default || !1;
        ...
        var e, o, t = PUM.getPopup(this), n = t.popmake("getSettings").triggers || [];
        if (n.length) for (o = 0; o < n.length; o += 1) e = n[o], t.popmake("addTrigger", e.type, e.settings)
    })
    ...
    Array.prototype.indexOf || (Array.prototype.indexOf = function (e) {
        ...
        scrollTo: function (e, o) {
            var t = a(e) || a();
            t.length && a("html, body").animate({scrollTop: t.offset().top - 100}, 1e3, "swing", function () {
            ...
            function l(e) {
                var o = e.split(" "), t = o[0], n = o[1].substring(0, 3), i = /\d+/.test(t),
                ...
                if ("next" === t || "last" === t) t = t, e = e, void 0 !== (n = a[n = n]) && (0 === (n = n - s.getDay()) ? n = 7 * e : 0 < n && "last" === t ? n -= 7 : n < 0 && "next" === t && (n += 7), s.setDate(s.getDate() + n)); else if (!i) return;
                return 1
            }
            ...
            for (c = 0, u = n.length; c < u; c += 1) if (!l(n[c])) return !1;
            return s.getTime() / 1e3
        }, serializeObject: function (e) {
            a.extend({}, e);
            var o = {}, t = a.extend(!0, {include: [], exclude: [], includeByClass: ""}, e);
    ...
    i.m = t, i.c = n, i.d = function (e, o, t) {
        ...
        if (i.r(t), Object.defineProperty(t, "default", {
            enumerable: !0,
            value: o
        }), 2 & e && "string" != typeof o) for (var n in o) i.d(t, n, function (e) {
            return o[e]
        }.bind(null, n));
        return t
    }, i.n = function (e) {
    ...
    (0, window.jQuery)(document).on("cf.ajax.request", function (e, o) {
        ...
        "complete" !== o.data.status && "success" !== o.data.status || (t = n.attr("id").split("_"), t = (o = i()(t, 2))[0], o = void 0 === (o = o[1]) ? null : o, window.PUM.integrations.formSubmission(n, {
            ...
            formId: t,
            formInstanceId: o,
            extras: {state: window.cfstate.hasOwnProperty(t) ? window.cfstate[t] : null}
        }))
    })
}]), function (t) {
    var n = {};
    ...
    0: function (o, e) {
        ...
        "use strict";
        t.r(o);
        var o = t(0), i = t.n(o), r = window.jQuery;
        r(document).on("wpcf7mailsent", function (e, o) {
            var t = e.detail.contactFormId, n = r(e.target),
    ...
    9: function (e, o) {
        var r = window.jQuery;
        r(document).on("fluentform_submission_success", function (e, o) {
            var t = o.form, n = o.config.id, i = t.data("form_instance");
            console.log(n, o), window.PUM.integrations.formSubmission(r(t), {
    ...
    10: function (e, o) {
        ...
        r(document).on("frmFormComplete", function (e, o, t) {
            var n = r(o), i = n.find('input[name="form_id"]').val(),
    ...
    0: function (o, e) {
        ...
        "use strict";
        t.r(o);
        var o = t(0), n = t.n(o), i = window.jQuery, r = {};
        i(document).on("gform_confirmation_loaded", function (e, o) {
            ...
            i(".gform_wrapper > form").each(function () {
                var e = i(this), o = e.attr("id").replace("gform_", ""), e = e.find("input.gforms-pum"),
    ...
    12: function (e, o) {
        ...
        r(function () {
            "undefined" != typeof mc4wp && mc4wp.forms.on("success", function (e, o) {
                var t = r(e.element), n = e.id, i = r(".mc4wp-form-" + e.id).index(t) + 1;
                window.PUM.integrations.formSubmission(t, {
                    formProvider: "mc4wp",
                    formId: n,
                    formInstanceId: i,
    ...
    "use strict";
    t.r(o);
    var o = t(1), a = t.n(o), p = window.jQuery, n = !1;
    p(function () {
        "undefined" != typeof Marionette && "undefined" != typeof nfRadio && !1 === n && new (n = Marionette.Object.extend({
            initialize: function () {
                ...
                var i = p("#nf-form-" + n + "-cont"), r = n.split("_"), s = a()(r, 2), n = s[0], r = s[1],
                    s = void 0 === r ? null : r, r = {};
    ...
    14: function (e, o) {
        ...
        r(document).on("wpformsAjaxSubmitSuccess", ".wpforms-ajax-form", function (e, o) {
            var t = r(this), n = t.data("formid"), i = r("form#" + t.attr("id")).index(t) + 1;
    ...
    15: function (e, o) {
        ...
        s(document).on("wsf-submit-success wsf-save-success", function (e, o, t, n, i, r) {
            window.PUM.integrations.formSubmission(s(i), {formProvider: "wsforms", formId: t, formInstanceId: n})
        })
    }
}), function (e) {
    ...
    function s(o, e) {
        try {
            ...
            if (e && ("object" == typeof e || "function" == typeof e)) {
                ...
                if ("function" == typeof t) return void l((n = t, i = e, function () {
                    n.apply(i, arguments)
                }), o)
            }
